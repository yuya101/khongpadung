...
public class LoginItemDao implements Parcelable {
    ...
    protected LoginItemDao(Parcel in) {
        bname = in.readString();
    ...
    public static final Creator<LoginItemDao> CREATOR = new Creator<LoginItemDao>() {
        @Override
        public LoginItemDao createFromParcel(Parcel in) {
            return new LoginItemDao(in);
        }

        @Override
        public LoginItemDao[] newArray(int size) {
            return new LoginItemDao[size];
        }
    };
