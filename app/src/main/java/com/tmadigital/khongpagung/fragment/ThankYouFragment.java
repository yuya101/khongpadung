...
public class ThankYouFragment extends Fragment {
    ...
    private void initInstances(View rootView, Bundle savedInstanceState) {
        ...
        button = (Button) rootView.findViewById(R.id.gotoShoppingBtn);
        button.setOnClickListener(gotoShoppingListener);
    }
    ...
    final View.OnClickListener gotoShoppingListener = new View.OnClickListener() {
        @Override
