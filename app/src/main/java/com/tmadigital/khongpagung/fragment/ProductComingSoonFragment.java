...
import com.tmadigital.khongpagung.adapter.ProductListComingAdapter;
...
import com.tmadigital.khongpagung.manager.ProductList2DComingManager;
 ...
 */
public class ProductComingSoonFragment extends Fragment {

    GridView gridView;
    SwipeRefreshLayout swipeRefreshLayout;
    ProductListComingAdapter listComingAdapter;
    ProductList2DComingManager productList2DComingManager;
    ...
    public ProductComingSoonFragment() {
        super();
    }

    public static ProductComingSoonFragment newInstance() {
        ProductComingSoonFragment fragment = new ProductComingSoonFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_product_coming_soon, container, false);
    ...
    private void initInstances(View rootView) {
        ...
        listComingAdapter = new ProductListComingAdapter();
        gridView.setAdapter(listComingAdapter);
        ...
        productList2DComingManager = ProductList2DComingManager.getInstance();
    ...
    private void reloadData() {
        ...
        Call<ProductAllItemCollectionDao> call = HttpManager.getInstance().getService().loadProductList("4", "");
        call.enqueue(new Callback<ProductAllItemCollectionDao>() {
            ...
            public void onResponse(Call<ProductAllItemCollectionDao> call,
                ...
                if (response.isSuccessful()){
                    ...
                    ProductList2DComingManager.getInstance().setDao(dao);
                    listComingAdapter.notifyDataSetChanged();
    ...
    final AdapterView.OnItemClickListener gridViewItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if(position < productList2DComingManager.getDao().getProducts().size()){
                ProductAllItemDao dao = productList2DComingManager.getDao().getProducts().get(position);
