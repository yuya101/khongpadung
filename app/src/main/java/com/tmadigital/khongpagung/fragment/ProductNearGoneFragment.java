...
import com.tmadigital.khongpagung.adapter.ProductListNearGoneAdapter;
 ...
 */
public class ProductNearGoneFragment extends Fragment {

    GridView gridView;
    SwipeRefreshLayout swipeRefreshLayout;
    private ProductListNearGoneAdapter listNearGoneAdapter;
    private ProductList2DNearGoneManager productList2DNearGoneManager;
    ...
    public ProductNearGoneFragment() {
        super();
    }

    public static ProductNearGoneFragment newInstance() {
        ProductNearGoneFragment fragment = new ProductNearGoneFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_product_near_gone, container, false);
    ...
    private void initInstances(View rootView) {
        ...
        listNearGoneAdapter = new ProductListNearGoneAdapter();
        gridView.setAdapter(listNearGoneAdapter);
        ...
        productList2DNearGoneManager = ProductList2DNearGoneManager.getInstance();
        ...
        call.enqueue(new Callback<ProductAllItemCollectionDao>() {
            ...
            public void onResponse(Call<ProductAllItemCollectionDao> call,
                ...
                if (response.isSuccessful()){
                    ...
                    ProductList2DNearGoneManager.getInstance().setDao(dao);
                    listNearGoneAdapter.notifyDataSetChanged();
    ...
    final AdapterView.OnItemClickListener gridViewItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if(position < productList2DNearGoneManager.getDao().getProducts().size()){
                ProductAllItemDao dao = productList2DNearGoneManager.getDao().getProducts().get(position);
