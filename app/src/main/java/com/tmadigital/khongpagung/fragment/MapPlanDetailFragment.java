 ...
 */
public class MapPlanDetailFragment extends Fragment {



    public MapPlanDetailFragment() {
        super();
    }

    public static MapPlanDetailFragment newInstance() {
        MapPlanDetailFragment fragment = new MapPlanDetailFragment();
    ...
    private void initInstances(View rootView) {
        ...
        imageView.setImage(ImageSource.resource(R.drawable.plan));
        // ... or ...
