...
import com.tmadigital.khongpagung.fragment.CheckRedeemProductHistoryFragment;
import com.tmadigital.khongpagung.method.SamplinkMethod;

import uk.co.chrisjenx.calligraphy.CalligraphyContextWrapper;

public class CheckRedeemProductHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_redeem_product_history);

        initInstances();

        if (savedInstanceState == null){
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.checkRedeemProductHistoryContainer, CheckRedeemProductHistoryFragment.newInstance())
                    .commit();
        }
    }
    ...
    private void initInstances() {
        ...
        toolbar = (Toolbar) findViewById(R.id.checkRedeemProductHistoryToolbar);
        setSupportActionBar(toolbar);

        drawerLayout = (DrawerLayout) findViewById(R.id.checkRedeemProductHistoryDrawerLayout);

        actionBarDrawerToggle = new ActionBarDrawerToggle(
                CheckRedeemProductHistoryActivity.this,
                drawerLayout,
