...
import com.tmadigital.khongpagung.fragment.ThankYouFragment;
...
public class ThankYouActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null){
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.thankyouContainer, ThankYouFragment.newInstance())
                    .commit();
        }
    }
    ...
    private void initInstances() {
        ...
        toolbar = (Toolbar) findViewById(R.id.thankyouToolbar);
        setSupportActionBar(toolbar);

        drawerLayout = (DrawerLayout) findViewById(R.id.thankyouDrawerLayout);
