...
import com.tmadigital.khongpagung.fragment.CheckPointHistoryFragment;
import com.tmadigital.khongpagung.method.SamplinkMethod;

import uk.co.chrisjenx.calligraphy.CalligraphyContextWrapper;

public class CheckPointHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null){
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.checkPointHistoryContainer, CheckPointHistoryFragment.newInstance())
                    .commit();
        }
    }
    ...
    private void initInstances() {
        ...
        toolbar = (Toolbar) findViewById(R.id.checkPointHistoryToolbar);
        setSupportActionBar(toolbar);

        drawerLayout = (DrawerLayout) findViewById(R.id.checkPointHistoryDrawerLayout);

        actionBarDrawerToggle = new ActionBarDrawerToggle(
                CheckPointHistoryActivity.this,
                drawerLayout,
